...
- **카드 옮기기·지우기**: 카드를 끌어 옮깁니다. 텍스트 카드도 어디를 잡든 끌리고, 끌지 않고 톡 누르면 글쓰기가 시작됩니다(글쓰기 중에 옮기려면 위쪽 점무늬 띠를 잡습니다). 카드에 마우스를 올리면 오른쪽 위에 휴지통이 나옵니다.
...
- 아직 없는 것: 여러 카드 한꺼번에 선택/이동, 묶음(그룹), 되돌리기(undo), 작업(Job) 카드, 여러 사람 동시 편집.
